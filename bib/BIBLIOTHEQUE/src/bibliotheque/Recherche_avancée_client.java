 ...
 * @author Myriam
 */
public class Recherche_avancée_client extends javax.swing.JFrame {

    /**
     * Creates new form Recherche_avancée_client
     */
    public Recherche_avancée_client() {
        initComponents();
    }
    Employee emp;
     public Recherche_avancée_client(Employee emp) {
        initComponents();
          this.emp=emp;
      ...
      ImageIcon getIcon(){
       ...
       byte[] bytea=null;
        try {
            bytea = (this.emp.getPhoto()).getBytes(1,(int)(this.emp.getPhoto()).length());
        } catch (SQLException ex) {
            Logger.getLogger(Recherche_avancée_client.class.getName()).log(Level.SEVERE, null, ex);
        }
       try{
    ...
    private void initComponents() {
        ...
        jLabel40.setText("ADMIN Departement");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cin", "Nom", "Prenom", "Email", "Date de naissance", "Date d'inscription", "nb des livres effectués", "nb des livres en cours", "nb des livres depassés"
            }
        ));
        ...
        colonne.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "_____________________", "Cin", "nom", "prenom", "Email", "Date_naiss", "Date_inscription", "nbr_livre_effectué", "nbr_livre_depassé", "nbr_livre_encours" }));
        ...
        jPanel29Layout.setVerticalGroup(
            jPanel29Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel30, javax.swing.GroupLayout.PREFERRED_SIZE, 549, Short.MAX_VALUE)
            .addGroup(jPanel29Layout.createSequentialGroup()
 ...
 DefaultTableModel tableModel = new DefaultTableModel(new Object[][]{}, new Object[]{"Cin", "Nom", "Prenom", "Email", "Date de naissance", "Date d'inscription", "nb des livres effectués", "nb des livres en cours","nb des livres depassés"});
    Gestion_Employee gest = new Gestion_Employee();
    Vector<Client> list;
     try {
         list = gest.affichier_recherche_avancee_client((String) colonne.getSelectedItem(), value.getText());
 

    for (Client element : list) {
        Object[] rowData = {element.getCin(), element.getNom(), element.getPrenom(), element.getEmail(), element.getDate_naiss(), element.getDate_inscription(), element.getNbr_livre_effectuee(),element.getNbr_livre_en_cours() ,element.getNbr_livre_depassee()};
...
new Welcome().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Recherche_avancée_client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Recherche_avancée_client().setVisible(true);
            }
        });
    }
