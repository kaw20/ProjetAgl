 ...
 * @author Myriam
 */
public class afficher_tous_livres extends javax.swing.JFrame {

    /**
     * Creates new form afficher_tous_livres
     */
    public afficher_tous_livres() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Image", "Code", "Titre", "Auteur", "Rating", "Nbr_copies", "Genre", "Disponibilité", "Description"
            }
        ));
        ...
        colonne.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "_____________________", "Code", "Titre", "Auteur", "Genre" }));
    ...
    Vector<Livre> list;
    try {
        list = gest.affichier_recherche_avancee_livre((String) colonne.getSelectedItem(), value.getText());

        for (Livre element : list) {
            // Get the BLOB data as InputStream
            Blob blob = element.getPhoto(); // Assuming getPhoto() returns the BLOB
            ...
            Image resizedImage = image.getScaledInstance(100, 100, Image.SCALE_SMOOTH); // Example: resize to 100x100

            // Create a JLabel to display the image
            JLabel label = new JLabel(new ImageIcon(resizedImage));
            // Assuming you want to display the image in the first column
            tableModel.addRow(new Object[]{label, element.getCode(), element.getTitre(), element.getAuteur(), element.getRating(), element.getNbr_copies(), element.getGenre(), element.isDispo(), element.getDescription()});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(afficher_tous_livres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new afficher_tous_livres().setVisible(true);
            }
        });
    }
