...
public class Recherche_Client extends javax.swing.JFrame {
    ...
    public Recherche_Client() {
     ...
     public Recherche_Client(Employee emp) {
        initComponents();  this.emp=emp;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Chercher un Client");
    ...
    private void chercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chercherActionPerformed
        ...
        Client clt0= gest.afficher_client(Integer.parseInt(cin_txt.getText()));

        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

        String date_naissance = clt0.getDate_naiss().format(formatter);
        String date_inscrip = clt0.getDate_inscription().format(formatter);

        cin_carte.setText(String.valueOf(clt0.getCin()));//String.valueOf() va convertir le cin(entier) en chaine
        nom_carte.setText(clt0.getNom());
        prenom_carte.setText(clt0.getPrenom());
        email_carte.setText(clt0.getEmail());
        phone_carte.setText(String.valueOf(clt0.getNum_tlfn()));
        date_naissance_carte.setText(date_naissance);
        inscrip_carte.setText(date_inscrip);
        photo_new.setIcon(getIcon(clt0));
...
ImageIcon getIcon(Client clt1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Recherche_Client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
