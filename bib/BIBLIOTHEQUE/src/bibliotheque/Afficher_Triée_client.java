 ...
 * @author Myriam
 */
public class Afficher_Triée_client extends javax.swing.JFrame {

    /**
     * Creates new form Afficher_Triée
     */
    public Afficher_Triée_client() {
        initComponents();
    }
      Employee emp;
            gest_photo gestPhoto=new gest_photo();
            String path;
    public Afficher_Triée_client(Employee emp) {
        initComponents();
            this.emp=emp;
    }
    ...
    private void initComponents() {
        ...
        jLabel38.setText("Afficher tous les Clients en ordre croissant");
 ...
 DefaultTableModel tableModel = new DefaultTableModel(new Object[][]{}, new Object[]{"Cin", "Nom", "Prenom", "Email", "Date de naissance", "Date d'inscription", "nb des livres effectués", "nb des livres en cours","nb des livres depassés"});
    ...
    Vector<Client> list;
     try {
         list = gest.affichier_client_tous_trié();
for (Client element : list) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Afficher_Triée_client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Afficher_Triée_client().setVisible(true);
            }
        });
    }
